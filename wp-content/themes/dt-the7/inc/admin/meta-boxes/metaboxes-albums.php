	...
	'fields' 	=> array(
		...
		array(
			...
			'options'	=> array(
				...
				'masonry_grid' 		=> array( _x('Masonry & Grid', 'backend metabox', LANGUAGE_ZONE), array('gallery-masonry-and-grid.gif', 75, 50) ),
				'jgrid' 			=> array( _x('Justified Grid', 'backend metabox', LANGUAGE_ZONE), array('gallery-j-grid.gif', 75, 50) )
			),
			'hide_fields'		=> array(
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'masonry layout', array(
			...
			'divider' => 'top',
			'options' => array(
				'masonry'	=> array( _x( 'Masonry', 'backend metabox', LANGUAGE_ZONE ), array( 'gallery-masonry.gif', 60, 48 ) ),
				'grid'		=> array( _x( 'Grid', 'backend metabox', LANGUAGE_ZONE ), array( 'gallery-grid.gif', 60, 48 ) )
			)
		) ),
